"""Regression checks for the anchor-data-lake-forge casebook."""
...
from casebook.harness import assert_expected, anchor_data_lake_forge_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(anchor_data_lake_forge_summary(), assert_expected())
