...
anchor-data-lake-forge is a C++ project for data engineering. It focuses on this technical goal: Build a C++ toolkit that studies lake behavior through framed sample traffic, with bounds and ordering tests and bounded memory input sets.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 150, risk penalty 4, latency penalty 4, and weight bonus 2. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
